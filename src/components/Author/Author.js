...
import './Author.css';
import store, { UPDATEFIRST, UPDATELAST } from './../../store'
...
class Author extends Component {
  ...
  saveChanges() {
    store.dispatch({ type: UPDATEFIRST, payload: this.state.authorFirst })
    store.dispatch({ type: UPDATELAST, payload: this.state.authorLast})
  }
  render() {
    return (
